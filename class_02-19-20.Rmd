...
## Class Notes
Regression to the mean: when you keep sampling variables, they will tend towards the mean, but variabilit stays roughly the same because of an error parameter.


```{r midterm_complaints}
# Grade adjustment on midterms and grade improvements in students' scores
# RCM: Counterfactual: not adjusting grades; factual: adjusting grades. 
...
treatment <- c(rep(0, n_1), rep(1, n_2))
fake <- data.frame(treatment, score)
